...
class MainPage:
    ...
    def check_text_question_heading(self):
        ...
        assert expected_value in actually_value, f'Ожидалось значение поля: "{expected_value}", получено ' \
                                                 f'"{actually_value}"'
    ...
    def check_text_question_1(self):
        ...
        assert actually_value == expected_value, f'Ожидалось значение поля Пароль: "{expected_value}", получено' \
                                                 f' "{actually_value}"'
